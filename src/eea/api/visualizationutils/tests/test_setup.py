...
class TestSetup(unittest.TestCase):
    ...
    def test_browserlayer(self):
        ...
        from eea.api.visualizationutils.interfaces import (
            IEeaApiVisualizationutilsLayer
        )
        from plone.browserlayer import utils

        self.assertIn(IEeaApiVisualizationutilsLayer,
                      utils.registered_layers())


class TestUninstall(unittest.TestCase):
    """Test that eea.api.visualizationutils is cleanly uninstalled."""
    layer = EEA_API_VISUALIZATIONUTILS_INTEGRATION_TESTING
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(IEeaApiVisualizationutilsLayer,
                         utils.registered_layers())
